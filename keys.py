...
'î', 'ï', 'ð', 'ñ', 'ò', 'ó', 'ô', 'õ', 'ö', '÷', 'ø', 'ù', 'ú', 'û', 'ü', 'ý', 'þ', 'ε', '\t', '\n']
anyy = [x for x in symbols if x not in operator_symbols]
nospace = [x for x in symbols if x not in [' ', '\n', '\t']]